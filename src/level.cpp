...
Level::Level()
{
    ...
    _staticEntities.push_back(new Block(10, 10, 50, 380));
    _staticEntities.push_back(new Block(60, 280, 100, 50, Qt::blue));
    ...
    _staticEntities.push_back(new Block(10, 350, 700, 50));
